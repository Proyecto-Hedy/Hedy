  ...
  return ( 
    <div id="google-account" className="text-xs flex items-center justify-center m-4 p-2 rounded-lg bg-gray-bg gap-2 border shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px]">
      <div>
        ...
        : (
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="w-[30px] h-[30px]"><path d="M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>
        )
        }
      </div>
      <div>
